    ...
    <div class="max-w-7xl mx-auto px-4 py-10">
        ...
        <div class="relative w-full h-80 md:h-96 rounded-2xl overflow-hidden shadow-lg mb-8">
            ...
            <div class="absolute bottom-6 left-6 text-white">
                <h1 class="text-3xl md:text-4xl font-bold tracking-tight"><?php echo e($property->title); ?></h1>
                <p class="text-yellow-400 text-2xl md:text-3xl font-semibold mt-2">Rs. <?php echo e(number_format($property->price)); ?></p>
                <div class="flex gap-4 mt-3 items-center flex-wrap">
                    <span class="bg-yellow-400 text-black px-3 py-1 rounded-full font-medium text-sm"><?php echo e($property->property_type); ?></span>
                    <span class="flex items-center gap-1 text-sm font-medium"><i class="fas fa-map-marker-alt"></i> <?php echo e($property->address); ?>, <?php echo e($property->city); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-10">
            <div class="md:col-span-3">
                <img id="mainImage" src="<?php echo e($property->images->count() ? asset('storage/' . $property->images->first()->file_path) : ''); ?>" 
                     alt="Property" 
            ...
            <div class="md:col-span-2 flex flex-col gap-3">
                <?php $__currentLoopData = $property->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <img src="<?php echo e(asset('storage/' . $image->file_path)); ?>" 
                         ...
                         onclick="document.getElementById('mainImage').src='<?php echo e(asset('storage/' . $image->file_path)); ?>'">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            ...
            <div class="bg-gray-50 p-6 rounded-3xl shadow-md hover:shadow-lg transition transform hover:-translate-y-1">
                ...
                <p class="text-gray-700 mb-6 leading-relaxed text-base md:text-lg"><?php echo e($property->description); ?></p>
               ...
               <div class="grid grid-cols-2 gap-4">
                    ...
                    <?php $__currentLoopData = $details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-white p-4 rounded-2xl shadow hover:shadow-xl transition transform hover:-translate-y-1 flex flex-col items-start gap-1">
                            <i class="<?php echo e($item['icon']); ?> text-black text-xl mb-1"></i>
                            <p class="font-semibold text-black text-sm"><?php echo e($item['label']); ?></p>
                            <?php if(is_numeric($item['value'])): ?>
                                <p class="text-gray-700 text-lg counter" data-target="<?php echo e($item['value'] ?? 0); ?>">0</p>
                            <?php else: ?>
                                <p class="text-gray-700 text-lg"><?php echo e($item['value'] ?? '–'); ?></p>
                            <?php endif; ?>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            ...
            <div class="flex flex-col gap-6">
                <div class="bg-white p-6 rounded-3xl shadow-md hover:shadow-xl transition transform hover:-translate-y-1">
                    <div class="flex items-center gap-4 mb-4">
                        <div class="w-16 h-16 rounded-full bg-gray-200 flex items-center justify-center text-gray-400 text-2xl font-bold">
                            <?php echo e(strtoupper(substr($property->member->user->name ?? 'U', 0, 1))); ?>

                        </div>
                        <div>
                            <h3 class="text-xl font-semibold text-black"><?php echo e($property->member->user->name ?? 'Unknown'); ?></h3>
                            <p class="text-gray-600 text-sm"><?php echo e($property->member->user->email ?? 'N/A'); ?></p>
                            <p class="text-gray-600 text-sm"><?php echo e($property->member->phone ?? 'N/A'); ?></p>
                        </div>
                    </div>
                    <div class="flex gap-3 mt-4 flex-wrap">
                        <a href="mailto:<?php echo e($property->member->user->email ?? ''); ?>" class="px-5 py-2 bg-yellow-400 text-black rounded-xl shadow hover:bg-yellow-300 transition font-medium flex items-center gap-2">
                ...
                <a href="<?php echo e(route('member.purchase.form', $property->id)); ?>">
...
<?php endif; ?>
<?php /**PATH C:\Users\banda\OneDrive\Desktop\PropertEase\resources\views/member/propertyshow.blade.php ENDPATH**/ ?>