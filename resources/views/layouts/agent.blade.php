...
<head>
  ...
  <title>{{ config('app.name', 'PropertEase') }} - Agent Dashboard</title>
...
<body class="bg-gray-50 text-gray-900 font-[Poppins]">
  ...
  <header class="bg-white shadow-md sticky top-0 z-50">
    <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
      ...
      <!-- Logo -->
      <a href="{{ route('agent.dashboard') }}" class="flex items-center gap-3 hover:scale-105 transition-transform duration-300">
